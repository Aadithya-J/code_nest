...
// Basic project reference used across services.
type ProjectRef struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ProjectId     string                 `protobuf:"bytes,1,opt,name=project_id,json=projectId,proto3" json:"project_id,omitempty"` // UUID
	AtlasId       string                 `protobuf:"bytes,2,opt,name=atlas_id,json=atlasId,proto3" json:"atlas_id,omitempty"`       // "ws-{uuid}"
...
func (x *ProjectRef) GetAtlasId() string {
	if x != nil {
		return x.AtlasId
	}
	return ""
...
const file_proto_common_proto_rawDesc = "" +
	"\n" +
	"\x12proto/common.proto\x12\x06common\"F\n" +
	"\n" +
	"ProjectRef\x12\x1d\n" +
	"\n" +
	"project_id\x18\x01 \x01(\tR\tprojectId\x12\x19\n" +
	"\batlas_id\x18\x02 \x01(\tR\aatlasIdB-Z+github.com/Aadithya-J/code_nest/proto;protob\x06proto3"
...
var file_proto_common_proto_goTypes = []any{
	(*ProjectRef)(nil), // 0: common.ProjectRef
}
